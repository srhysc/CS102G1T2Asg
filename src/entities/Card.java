 ...
 * Each card has a colour, a value (like points), and can be face up or face
 * down.
 * Also includes some ANSI colour codes so the card colours are shown when
...
public class Card implements Serializable {
    ...
    /**
     * Face down cards mean that they are the majority set so their values are not
     * computed.
     * 
     ...
     * 
     * @param colour The colour of the card in String format (eg. "red", "blue",
     *               etc.)
     */
    ...
    /**
     * Get the ANSI colour code for the card's colour. It is used for making console
     * text coloured.
     * 
    ...
    public String getcolorCode() {
        switch (colour.toLowerCase()) {
            ...
            case "orange":
                ...
                break;
            default:
                colorCode = "\u001B[0m"; // Reset if unknown color
        }
