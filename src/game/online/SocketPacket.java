...
/**
 * Constructs a new SocketPacket object for communication between the server and
 * clients.
 *
 * Parameters:
 * - {@code sb} – A {@link StringBuilder} containing the message content.
 * - {@code currentPlayer} – A {@link String} representing the name of the
 * current player.
 * - {@code messageType} – An integer representing the type of message (e.g.,
 * announcement, move request).
 * - {@code playerList} – An {@link ArrayList} of {@link Player} objects
...
public class SocketPacket implements Serializable {
     ...
     *
     * Parameters:
     * - {@code currentPlayer} – A {@link String} representing the new current
     * player name.
     */
     ...
     *
     * Returns:
     * - An integer representing the message type (e.g., 0 for announcement, 1 for
     * move request).
     */
     ...
     *
     * Returns:
     * - An {@link ArrayList} of {@link Player} objects representing the players in
     * the game.
     */
     ...
     *
     * Parameters:
     * - {@code name} – A {@link String} representing the name of the player to
     * retrieve.
     *
     * Returns:
     * - A {@link Player} object matching the given name, or {@code null} if no
     * player with the name is found.
     */
     ...
     * Parameters:
     * - {@code playerList} – An {@link ArrayList} of {@link Player} objects
     * representing the new player list.
     */
